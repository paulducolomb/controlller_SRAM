...
synth_design -top control_SRAM -part xc7z020clg484-1
...
write_checkpoint -force -noxdef control_SRAM.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file control_SRAM_utilization_synth.rpt -pb control_SRAM_utilization_synth.pb"
