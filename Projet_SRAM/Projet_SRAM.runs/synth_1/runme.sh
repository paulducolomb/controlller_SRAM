...
HD_PWD='C:/Users/pauld/controlller_SRAM/Projet_SRAM/Projet_SRAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_SRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_SRAM.tcl
