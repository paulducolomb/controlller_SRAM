...
HD_PWD='C:/Users/pauld/Projet_SRAM/Projet_SRAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log control_SRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source control_SRAM.tcl -notrace
