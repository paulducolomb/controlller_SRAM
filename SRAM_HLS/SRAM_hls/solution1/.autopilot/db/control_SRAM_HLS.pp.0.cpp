...
# 2 "control_SRAM_HLS.cpp" 2

enum State {IDLE, INIT, WRITE_DATA, READ_CAPTURE, BURST_WRITE, BURST_READ};

__attribute__((sdx_kernel("control_SRAM_HLS", 0))) void control_SRAM_HLS(
    ap_uint<19> addr_in,
    ap_uint<36> data_in,
    ap_uint<36> &data_out,
    bool we,
...
{
#pragma HLSDIRECTIVE TOP name=control_SRAM_HLS
# 25 "control_SRAM_HLS.cpp"
